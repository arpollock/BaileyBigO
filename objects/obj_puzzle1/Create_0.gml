...
obj_storyPopUp.content = "Before Bailey and Nelly can move on they have to organize the birds the way they should be. Use [space] for Bailey and [enter] for Nelly to change the crates to match the corresponding binary numbers.\nGreen = 1, Red = 0";
